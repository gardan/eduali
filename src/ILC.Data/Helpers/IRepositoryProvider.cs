...
namespace Ilc.Data.Helpers
{
    ...
    /// The class may create the repository dynamically if it is unable 
    /// to find one in its chache.
    /// </summary>
    /// <remarks>
    ...
    public interface IRepositoryProvider
    {
        ...
        /// </summary>
        /// <typeparam name="T">
        /// Type of the respository, typically a custom repository interface.
        /// </typeparam>
        /// <param name="factory">
        ...
        /// If found, tries to make one with the factory, falling back to
