Ext.define('Ilc.resources.Resources', {
    ...
    resources: {
        ...
        'common.print': 'Print',
        'common.date': 'Date',
        'common.start': 'Start time',
        'common.end': 'End time',
        'common.hours': 'Duration (hours)',
        'common.remainingHours': 'Remaining hours',
        'common.studentsToday': 'Show today only',
        'common.users': 'Users',
        'common.statusDefinitions': 'Training Status',
        'common.gradingSystems': 'Grading Systems',
        'common.importTrainers': 'Import Trainers',
        'common.importCustomers': 'Import Customers',
        'common.importStudents': 'Import Students',
        'common.documentTemplates': 'Document Templates',
        'common.expenseTypes': 'Expense Types',
        'common.all': 'All',
        'common.today': 'Today',
