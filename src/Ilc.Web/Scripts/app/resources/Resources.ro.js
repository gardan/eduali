Ext.define('Ilc.resources.Resources', {
	...
	'common.postcode': 'Cod poștal',
        ...
        'common.totalHours': 'Număr total de ore',
        'common.roles': 'Roluri',
        'common.print': 'Tiparește',
        'common.date': 'Data',
        'common.start': 'Început',
        'common.end': 'Sfarșit',
        'common.hours': 'Durata (ore)',
        'common.remainingHours': 'Ore rămase',
        'common.studentsToday': 'Astăzi',
        'common.users': 'Utilizatori',
        'common.statusDefinitions': 'Stări training',
        'common.gradingSystems': 'Sistem de gradare',
        'common.importTrainers': 'Import Traineri',
        'common.importCustomers': 'Import Clienti',
        'common.importStudents': 'Import Studenti',
        'common.documentTemplates': 'Sablon documente',
        'common.expenseTypes': 'Tipuri de cheltuieli',
        'common.all': 'Toate',
        'common.today': 'Astăzi',
        'common.week': 'Săptămana aceasta',
