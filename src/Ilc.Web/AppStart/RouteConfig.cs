...
namespace Ilc.Web.AppStart
{
    public class RouteConfig
    {
        public static void Init(IServiceRoutes routes)
        {
            ...
            routes.Add<Services.Tasks.Training.PendingValidationModel>("/api/tasks/training/validation", "POST");
            routes.Add<Services.Tasks.Training.UserRegistrationModel>("/api/tasks/training/registration", "POST");
            ...
            routes.Add<Services.UpdateLessonModel>("/api/trainings/{trainingId}/lessons", "POST");
            ...
            routes.Add<Services.AvailabilityModel>("/api/availabilities/{id}", "DELETE,PUT");

            routes.Add<Services.FilterParametersTemplates>("/api/templates", "GET");
            routes.Add<Services.TemplateModel>("/api/templates", "POST");
            ...
            routes.Add<Services.InterviewModel>("/api/interviews/{id}", "PUT");
